const suites = require('./config/suites.conf');
const { existsSync, mkdirSync, removeSync } = require('fs-extra');
let featureFileName = process.env.ff || '*';
...
exports.config = {
    ...
    //
    specs: [
        `./features/featureFiles/${featureFileName}.feature`
    ],
    suites: suites,
    // Patterns to exclude.
    exclude: [
    ...
    reporters: [
        'spec',
        ['cucumberjs-json', {
            jsonFolder: './reports/jsonReports/',
            language: 'en',
        }]
    ],
    ...
    // },
    onPrepare: function () {
        if (existsSync('./reports/jsonReports/')) {
            removeSync('./reports/jsonReports/');
        }
        if (existsSync('./reports/cucumber-html-reports/')) {
            removeSync('./reports/cucumber-html-reports/');
        }
        ...
        mkdirSync('./reports/jsonReports/');
        mkdirSync('./reports/cucumber-html-reports/');
    ...
    onComplete: function () {
        ...
        reporter.generate({
            ...
            output: `./reports/cucumber-html-reports/cucumber-html-report-${timestamp}.html`,
